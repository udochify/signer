<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="firstname" name="firstname" type="text" class="mt-1 block w-full" :value="old('firstname', $user->firstname)" autocomplete="firstname" />
        ...
        <div>
            ...
            <select name="gender" class="w-full mt-1 rounded-md border border-gray-300 border-solid hover:border-gray-500">
                <option @if($user->gender !='male' && $user->gender != 'female') selected @endif value=""><p class="text-xs text-gray-200">Nothing Selected</p></option>
